...
def begin():
    ...
    #tie_hit = pygame.mixer.Sound("./Audio/darthVader.mp3")
    ...
    #controlling vader ship using keys
    ...
    def xfighter_handle_bullets(xfighter_bullets, spaceship_location, lives):
        for bullet in reversed(xfighter_bullets):
            ...
            if bullet.x < 0:
                xfighter_bullets.remove(bullet)
            return lives
    #background movements (second vader ship)  
    ...
    #movement for enemy
    #increase in speed for movement of enemy
    ...
    def gameover(WIN):
        ...
        text1=gameoverfont1.render('Game Over!', 1 ,RED)
        ...
        while run:
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.KEYDOWN:
                    ...
                    # Quits game but remove before submitting (Press q)
            ...
            xfighter1_location, xfighter2_location, xfighter3_location, xfighter4_location, xfighter_count = vader_handle_bullets(vader_bullets, xfighter1_location, xfighter2_location, xfighter3_location, xfighter4_location, xfighter_count)
            
            #setting up xfighter movements
